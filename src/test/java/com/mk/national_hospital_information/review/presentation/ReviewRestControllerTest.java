...
class ReviewRestControllerTest extends AbstractMySqlTestContainers {
    ...
    void init() {
        ...
        reviewRequestDto = new ReviewRequestDto("testTitle", "testContent", 1L);
    }
    ...
    void saveReview() throws Exception {
        ...
        given(reviewService.save(anyLong(), anyLong(), any(ReviewRequestDto.class))).willReturn(review);
    ...
    void saveReview_fail_HOSPITAL_NOT_FOUND() throws Exception {
        doThrow(new GlobalException(
            ...
            ErrorCode.HOSPITAL_NOT_FOUND.getMessage())).when(reviewService).save(anyLong(), anyLong(), any(ReviewRequestDto.class));
    ...
    void updateReview() throws Exception {
        Review review = new Review(1L, "updateTitle", "updateContent", 1L, 1L, 1L);
        ReviewRequestDto updateDto = new ReviewRequestDto("updateTitle", "updateContent", 1L);

        given(reviewService.update(anyLong(), anyLong(), anyLong(), any(ReviewRequestDto.class))).willReturn(review);
        given(userService.findByUsername(anyString())).willReturn(user);
    ...
    void updateReview_fail_REVIEW_NOT_FOUND() throws Exception {
        doThrow(new GlobalException(
            ...
            ErrorCode.REVIEW_NOT_FOUND.getMessage())).when(reviewService).update(anyLong(), anyLong(), anyLong(), any(ReviewRequestDto.class));
    ...
    void deleteReviewNotFoundFailureTest() throws Exception {
        doThrow(new GlobalException(
            ErrorCode.REVIEW_NOT_FOUND,
            ErrorCode.REVIEW_NOT_FOUND.getMessage())).when(reviewService).delete(anyLong(), anyLong(), anyLong());
